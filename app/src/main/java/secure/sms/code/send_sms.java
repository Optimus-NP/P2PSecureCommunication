...
import com.example.securecommunication.R;
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
                ...
                if (phoneNo.length()>0 && message.length()>0){
                	...
                	if ( test == true ){
                		...
                		Toast.makeText(getBaseContext(), 
                                " Key Not Present. Please Exchange the key with the peer. ", 
            ...
            public void onClick(View v) 
            {
                ...
                if (phoneNo.length()>0 && message.length()>0){
                	...
                	//	r = 9;
                		...
                		Toast.makeText(getBaseContext(), 
                                " Key Present. Please Exchange message with the peer. ", 
                                Toast.LENGTH_SHORT).show();
                	}
                }else {
                    Toast.makeText(getBaseContext(), 
        ...
        See_Saved.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) 
            {
            	...
            	/**
            	 *  Display senders activity started
            	 */
