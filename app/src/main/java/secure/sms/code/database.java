...
public class database {
	   ...
	   /** Table for storing senders*/
	   public static String TABLE_NAME ;
	   /** Table name variable used to store sender's SMS */
	   ...
	   /** SQLite Statement to insert senders and to be precomplied */
	   private SQLiteStatement insertStmt_sender;
	   
	 //  private static final String INSERT = "insert into " + "(TABLE_NAME) ?" + "(message , key) values (? , ?)";
	   
	   /** Setting the precomplile form of insertStmt_sender */
