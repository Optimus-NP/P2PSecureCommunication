...
public class passwd_change extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Creating layout and adding elements to layout
         */
        ...
        Conf_passwd.setText("Confirm Password");
        ...
        /**
         * chaning the password for the application 
         */
        change_passwd.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	...
            	{
            		System.out.println("Passwd Does not Matched");
                	Toast.makeText(getBaseContext(), "Password Doesnot  Matched" , Toast.LENGTH_SHORT).show();
                	//e_Old_passwd.setText("");
                	e_New_passwd.setText("");
                	e_Conf_passwd.setText("");	
            	}
